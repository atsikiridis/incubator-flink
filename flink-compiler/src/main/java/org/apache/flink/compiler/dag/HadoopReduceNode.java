 ...
 */
public class HadoopReduceNode extends SingleInputNode {
	
	private HadoopReduceNode combinerUtilityNode;
	 ...
	 */
	public HadoopReduceNode(HadoopReduceOperatorBase<?, ?, ?> pactContract) {
		super(pactContract);
	...
	public HadoopReduceNode(HadoopReduceNode reducerToCopyForCombiner) {
	 ...
	 */
	@Override
	public HadoopReduceOperatorBase<?, ?, ?> getPactContract() {
		return (HadoopReduceOperatorBase<?, ?, ?>) super.getPactContract();
	}
	...
	protected List<OperatorDescriptorSingle> getPossibleProperties() {
		return Collections.<OperatorDescriptorSingle>singletonList(new HadoopReduceDescriptor());
	}
	...
	public HadoopReduceNode getCombinerUtilityNode() {
		if (this.combinerUtilityNode == null) {
			this.combinerUtilityNode = new HadoopReduceNode(this);
	...
	public static class HadoopReduceDescriptor extends OperatorDescriptorSingle {

		@Override
		public DriverStrategy getStrategy() {
			return DriverStrategy.HADOOP_REDUCE;
		}

		@Override
		public SingleInputPlanNode instantiate(Channel in, SingleInputNode node) {
			return new SingleInputPlanNode(node, "HadoopReduce ("+node.getPactContract().getName()+")", in, DriverStrategy.HADOOP_REDUCE);
		}

		@Override
		protected List<RequestedGlobalProperties> createPossibleGlobalProperties() {
			RequestedGlobalProperties rgp = new RequestedGlobalProperties();
			rgp.setAnyPartitioning(new FieldSet(1));
