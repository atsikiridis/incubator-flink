...
import org.apache.flink.hadoopcompatibility.mapred.HadoopMapredReduceFunction;
...
public class HadoopReduceFunctionITCase extends MultipleProgramsTestBase {
	...
	public void testStandardGrouping() throws Exception{
		...
		DataSet<Tuple2<IntWritable, IntWritable>> commentCnts = ds.
				groupBy(0).
				reduceGroup(new HadoopMapredReduceFunction<IntWritable, Text, IntWritable, IntWritable>(new CommentCntReducer()));
	...
	public void testUngroupedHadoopReducer() throws Exception {
		...
		DataSet<Tuple2<IntWritable, IntWritable>> commentCnts = ds.
				reduceGroup(new HadoopMapredReduceFunction<IntWritable, Text, IntWritable, IntWritable>(new AllCommentCntReducer()));
	...
	public void testConfigurationViaJobConf() throws Exception {
		...
		DataSet<Tuple2<IntWritable, IntWritable>> helloCnts = ds.
				groupBy(0).
				reduceGroup(new HadoopMapredReduceFunction<IntWritable, Text, IntWritable, IntWritable>(
